...
export default function TableStockManagement({data, params, dataLogin, loading}) {
                ...
                if (loading) {
                    return (
                        ...
                        >
                            ...
                            <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r text-center">
                                {' '}
                                {value.name}
                            </td>
                            ...
                            dataLogin?.role_id === 3 ? (
                                ...
                                <td className="px-6 py-4 border-r text-center">
                                    {
                                        value?.product_stocks[0]?.warehouse
                                            ?.city
                                    }
                                </td>
                            )}

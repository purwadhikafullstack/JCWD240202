                    ...
                    <div className="relative w-full max-w-2xl max-h-full">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <div className="flex items-center justify-between p-4 border-b rounded-t dark:border-gray-600">
                                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Add New Warehouse</h3>
                                ...
                                <form>
                                    <div className="block mb-3">
                                        ...
                                        <textarea
                                            ...
                                            name="street"
                                            onChange={(e) => {setInputFullAddress(e.target.value); setCountFullAddress(e.target.value.length);}}
                                    ...
                                    <div className="block mb-3">
                                        ...
                                        <select
                                            ...
                                            name="province"
                                        >
                                            <option value="" className="w-1/2 text-gray-200">Select Province</option>
                                            {dataProvinces.map(
                                                (value, index) => {
                                                    return (
                                    ...
                                    <div className="block mb-3">
                                        ...
                                        >
                                            ...
                                            {filterCities.map(
                                                (value, index) => {
                                                    return (
                                                        <option value={`${value.city_id} ${value.type} ${value.city_name}`} key={index}>
                                                            {value.type}{' '}
                                                            {value.city_name}
                                                        </option>
                                                    );
                                    ...
                                    <div className="block mb-3">
                                        <span className="block text-sm font-medium text-slate-700 mb-1">Subdistrict<span className="text-red-600">*</span></span>
                                        <input
                                    ...
                                    <div className="block">
                                        <span className="block text-sm font-medium text-slate-700 mb-1">Postal Code<span className="text-red-600">*</span></span>
                                        <input
                                            className="border border-gray-400 w-[300px] rounded-md px-2 h-10 disabled:text-gray-600 disabled:cursor-not-allowed w-full focus:outline-none focus:border-blue-700 focus:ring-blue-600 focus:ring-1"
                                            name="postcode"
                            ...
                            <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                <button
                                    ...
                                    onClick={() => {
                                        dispatch(addWarehouse(inputFullAddress, inputProvince, inputProvinceId, inputCity, inputCityId, inputSubdistrict, inputPostalCode, params));
                                    }}
                                >
                                    Confirm
                                </button>
